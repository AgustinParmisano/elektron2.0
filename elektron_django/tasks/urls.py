...
urlpatterns = [
    ...
    url(r'^datatask/(?P<pk>[0-9]+)/updatestate$', csrf_exempt(views.DataTaskUpdateStateView.as_view()), name='datatasks_update_state'),
    url(r'^datetimetask/(?P<pk>[0-9]+)/updatestate$', csrf_exempt(views.DateTimeTaskUpdateStateView.as_view()), name='datetimetasks_update_state'),
]
