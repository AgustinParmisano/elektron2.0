    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_state_date_on', models.DateTimeField(default=datetime.datetime(2018, 5, 10, 10, 48, 57, 57776))),
                ('last_state_date_off', models.DateTimeField(default=datetime.datetime(2018, 5, 10, 10, 48, 57, 57800))),
                ('enabled', models.BooleanField(default=False)),
                ('last_run', models.DateTimeField(default=datetime.datetime(2018, 5, 10, 10, 48, 57, 57863))),
