...
urlpatterns = [
    ...
    url(r'^(?P<pk>[0-9]+)/data/(?P<day1>\d{2})/(?P<month1>\d{2})/(?P<year1>\d{4})/(?P<day2>\d{2})/(?P<month2>\d{2})/(?P<year2>\d{4})/(?P<offset>\d+)/(?P<limit>\d+)/(?P<order>\d+)/$', csrf_exempt(views.DeviceDataBetweenDaysView.as_view()), name='device_data_between_days'),
    ...
    url(r'^(?P<pk>[0-9]+)/data/(?P<day1>\d{2})/(?P<month1>\d{2})/(?P<year1>\d{4})/(?P<hour1>\d{2})/(?P<day2>\d{2})/(?P<month2>\d{2})/(?P<year2>\d{4})/(?P<hour2>\d{2})/perday/(?P<offset>\d+)/(?P<limit>\d+)/(?P<order>\d+)/$', csrf_exempt(views.DeviceDataBetweenHoursPerDayView.as_view()), name='device_data_between_hours_perday'),
    ...
    url(r'^(?P<pk>[0-9]+)/data/(?P<day1>\d{2})/(?P<month1>\d{2})/(?P<year1>\d{4})/(?P<hour1>\d{2})/(?P<day2>\d{2})/(?P<month2>\d{2})/(?P<year2>\d{4})/(?P<hour2>\d{2})/(?P<offset>\d+)/(?P<limit>\d+)/(?P<order>\d+)/$', csrf_exempt(views.DeviceDataBetweenHoursView.as_view()), name='device_data_between_hours'),
    url(r'^(?P<pk>[0-9]+)/data/(?P<day1>\d{2})/(?P<month1>\d{2})/(?P<year1>\d{4})/(?P<hour1>\d{2})/(?P<day2>\d{2})/(?P<month2>\d{2})/(?P<year2>\d{4})/(?P<hour2>\d{2})/perhour/(?P<offset>\d+)/(?P<limit>\d+)/(?P<order>\d+)/$', csrf_exempt(views.DeviceDataBetweenHoursPerHourView.as_view()), name='device_data_between_hours_per_hour'),
